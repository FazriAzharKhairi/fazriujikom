            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        -->
                            <li class="scroll-to-section"><a href="#menu">Chefs</a></li>
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="{{ asset ('gambar/'.$c->image) }}" alt="Chef #1">
                        </div>
                        <div class="down-content">
                            <h4>{{ $c->nama }}</h4>
                            <span>{{ $c->keahlian }}</span>
                        </div>
                    </div>
                </div>
                @endforeach
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($menus as $m)
                    <div class="chef-item">
                        <div class="thumb">
                            <img src="{{ asset ('gambar/'.$m->image) }}" alt="Chef #1" style="width: 15rem">
                        </div>
                        <div class="down-content">
                        ...
                        <form id="contact" action="{{ route ('bookings.store') }}" method="post">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="people" name="people" id="people">
                                    <option value="people">Number Of Guests</option>
